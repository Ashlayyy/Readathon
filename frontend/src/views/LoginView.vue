  ...
  <main class="page login-page">
    <div class="login-card card">
      <div class="login-header">
        ...
        <p class="lead">Sign up with your name and email, or continue with Google.</p>
      </div>
      ...
      <form @submit.prevent="submit">
        ...
        <button type="submit" class="btn btn-primary full" :disabled="loading">
          {{ loading ? 'Please wait…' : mode === 'register' ? 'Join the Pool' : 'Log In' }}
        </button>
      </form>
      ...
      <p class="fine-print">
        ...
        Admins are determined by email address.
      </p>
    </div>
  </main>
</template>
